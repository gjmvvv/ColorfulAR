...
namespace GJM
{
    ...
    ///  
    /// </summary>
    public class GameObjectPool : Develop.MonoSingleton<GameObjectPool>
    {


        /// <summary>可能存放多个种类的对象，每个种类有多个对象 </summary>
       [SerializeField] private Dictionary<string, List<GameObject>> cache = new Dictionary<string, List<GameObject>>();
        ...
        {
            destoryGo.transform.SetParent(this.transform);
            //设置destoryGo隐藏
        ...
        /// <param name="key">创建的值</param>
        /// <param name="go">要创建的物体</param>
